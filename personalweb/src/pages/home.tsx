        ...
        <div className='flex flex-col h-screen'>
            ...
            <main className="bg-[#fff9f0] flex-grow p-7">
                <section className="container mx-auto">
                    ...
                    <p className="text-xl mt-2 text-[#7b8f65] font-sans italic font-stretch-semi-expanded tracking-widest text-center">Computer Science Student and Software Engineer/Designer</p>
