            ...
            <main className="bg-[#fff9f0] flex-grow p-4">
                <div className='flex flex-row items-start'>
                    <div className='flex flex-col space-y-6 text-xl flex-1 ml-10 mr-30 max-w-3xl'>
                        <img src={about} alt="about" className="w-100 h-20" />
                            <p>Hi I’m Olivia!</p>
                            ...
                            <p className='ml-3 text-lg'>I built this website as a way to document my journey in software development, share projects, and show my growth as a developer. </p>
                            <p className='ml-3 text-lg'>Feel free to explore and reach out if you’d like to connect!</p>
